...
export const About = () => {
  return (
    <section className="pt-10 pb-16 px-5 2xl:px-24 flex flex-col justify-center items-center flex-1">
      ...
      <p className=" xl:text-center text-xl xl:text-2xl mt-10 xl:mt-2 max-w-[800px]">
        ...
        специализация — создание удобных, адаптивных и современных интерфейсов с
        использованием технологий HTML, CSS, JavaScript, React, Next.js,
      ...
      <div className="mt-8 flex flex-col xl:flex-row items-center xl:items-stretch gap-16 justify-center -order-1 xl:order-none">
        ...
        <div className="xl:max-w-[650px] ">
          ...
          <p className="text-xl mt-8 leading-8">
            ...
            также решать сложные задачи, которые требуют нестандартного подхода.
          </p>
        </div>
      </div>
      <Stack />
